 ...
 * Hint: You will need to use special characters to produce the following output.*/
 ...
 var joke = "Why couldn't the shoes go out and play?\n They were all \"tied\" up! \n Your joke should take the format of a question and answer. \n  * The first line should be a question and the second line should be an answer. Hint: You will need to use special characters to produce the following output.";
