 ...
 *
 * @package WordPress
 * @subpackage Medical Supplements Store Lite
 */

/**
 * Class Medical_Supplements_Store_Customizer_Theme_Info_Main
 *
 * @since  1.0.0
 * @access public
 */
class Medical_Supplements_Store_Customizer_Theme_Info_Main extends WP_Customize_Section {
