...
if ( ! class_exists( 'Medical_Supplements_Store_Theme_Info' ) ) :

	/**
	 * Medical_Supplements_Store_Theme_Info class.
	 */
	class Medical_Supplements_Store_Theme_Info extends WP_Customize_Control {
		...
		/**
		 * Medical_Supplements_Store_Theme_Info constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'Medical_Supplements_Store_Theme_Info' );
		...
		public function enqueue() {
			wp_enqueue_style( 'medical-supplements-store-style', get_template_directory_uri() . '/inc/css/supplement-style.css', '1.0.0' );
		}
