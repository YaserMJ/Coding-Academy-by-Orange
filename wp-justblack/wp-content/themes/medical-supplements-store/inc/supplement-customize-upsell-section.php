 ...
 */
/**
 * Class Medical_Supplements_Store_Customizer_Upsell_Section
 */
class Medical_Supplements_Store_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Medical_Supplements_Store_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Medical_Supplements_Store_Customizer_Upsell_Section' );
