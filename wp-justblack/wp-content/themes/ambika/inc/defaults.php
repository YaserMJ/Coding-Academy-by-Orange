...
if ( ! function_exists( 'ambika_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function ambika_get_defaults() {
		$ambika_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
		...
		return apply_filters( 'ambika_option_defaults', $ambika_defaults );
	}
}

if ( ! function_exists( 'ambika_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function ambika_get_color_defaults() {
		$ambika_color_defaults = array(
			...
			'sidebar_widget_text_color' => '#555555',
		...
		return apply_filters( 'ambika_color_option_defaults', $ambika_color_defaults );
	}
}
...
if ( ! function_exists( 'ambika_get_default_fonts' ) ) {
	 ...
	 */
	function ambika_get_default_fonts( $filter = true ) {
		$ambika_font_defaults = array(
			...
			'font_blog_header_title_variants' => '300,500,600,700',
			...
			'font_widget_title_variants' => '300,500,600,700',
			...
			'font_buttons_variants' => '300,300italic,regular,italic,600,600italic,700,700italic,800,800italic',
			...
			'font_footer_variants' => '300,500,600,700',
			'footer_weight' => '500',
		...
		if ( $filter ) {
			return apply_filters( 'ambika_font_option_defaults', $ambika_font_defaults );
		}

		return $ambika_font_defaults;
	}
}

if ( ! function_exists( 'ambika_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function ambika_spacing_get_defaults( $filter = true ) {
		$ambika_spacing_defaults = array(
			'top_bar_top' => '5',
			'top_bar_right' => '40',
			'top_bar_bottom' => '2',
			'top_bar_left' => '40',
		...
		if ( $filter ) {
			return apply_filters( 'ambika_spacing_option_defaults', $ambika_spacing_defaults );
		}

		return $ambika_spacing_defaults;
	}
}

if ( ! function_exists( 'ambika_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function ambika_get_default_color_palettes() {
		$palettes = array(
			'#000000',
			'#222222',
			'#555555',
		...
		return apply_filters( 'ambika_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'ambika_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function ambika_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'ambika_typography_default_fonts', $fonts );
	}
}

define( 'AMBIKA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Montserrat:100,100italic,200,200italic,300,300italic,regular,italic,500,500italic,600,600italic,700,700italic,800,800italic,900,900italic|Poppins:300,500,600,700|Open+Sans:300,300italic,regular,italic,600,600italic,700,700italic,800,800italic' );
