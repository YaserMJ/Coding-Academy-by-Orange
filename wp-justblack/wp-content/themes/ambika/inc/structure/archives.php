...
if ( ! function_exists( 'ambika_archive_title' ) ) {
	add_action( 'ambika_archive_title', 'ambika_archive_title' );
	/**
	 * Build the archive title
	 *
	 */
	function ambika_archive_title() { ?>
		<header class="page-header<?php if ( is_author() ) echo ' clearfix';?>">
			<?php
			/**
			 * ambika_before_archive_title hook.
			 *
			 */
			do_action( 'ambika_before_archive_title' );
			?>
			...
			<?php
			/**
			 * ambika_after_archive_title hook.
			 *
			 */
			do_action( 'ambika_after_archive_title' );
			...
			/**
			 * ambika_after_archive_description hook.
			 *
			 */
			do_action( 'ambika_after_archive_description' ); ?>
		</header><!-- .page-header -->
		<?php
	}
}

if ( ! function_exists( 'ambika_filter_the_archive_title' ) ) {
	add_filter( 'get_the_archive_title', 'ambika_filter_the_archive_title' );
	/**
	 ...
	 */
	function ambika_filter_the_archive_title( $title ) {
		if ( is_category() ) {
