...
$navigation_active = ( 'nav-right-sidebar' == ambika_get_navigation_location() ) ? true : false;
...
?>
<div id="right-sidebar" itemtype="https://schema.org/WPSideBar" itemscope="itemscope" <?php ambika_right_sidebar_class(); ?>>
	<div class="inside-right-sidebar">
		<?php
		/**
		 * ambika_before_right_sidebar_content hook.
		 *
		 */
		do_action( 'ambika_before_right_sidebar_content' );
		...
		/**
		 * ambika_after_right_sidebar_content hook.
		 *
		 */
		do_action( 'ambika_after_right_sidebar_content' );
		?>
